...
> 第一种，这个方法是最简单也是最稳定的，先在`Github Desktop`把仓库下载到本地如果你是开着的话就在上方找到并点击`Fetch origin`这样就会把你在[静态博客管理后台](https://jingtaiboke.com/)上修改的东西下载下来，然后再点击中间的蓝色按钮`Pull origin`替换本地的。